...
<div class="wrapper">
  ...
  @include('admin.templatesLTE.main-header')
  @include('admin.templatesLTE.main-sidebar')
  ...
  @include('admin.templatesLTE.main-footer')
  @include('admin.templatesLTE.control-sidebar')
</div>
<!-- ./wrapper -->
